...
Reports saved to `../reports/` (configure as needed).

## Roadmap

- ScrapingBee integration for WAF-blocked tier
- Direct Tableau API integration (replaces manual export)
- Scheduled daily runs with notification
